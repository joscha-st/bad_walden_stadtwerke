...
public class BillingAddress {
	...
	public String toJson() {
		return "{" + createJsonPair("firstName", firstName) + "," + createJsonPair("lastName", lastName) + "," + createJsonPair("street", street) + "," + createJsonPair("houseNumber", houseNumber) + "," + createJsonPair("postalCode", postalCode) + "," + createJsonPair("city", city) + "}";
	}
